...
const TopNavAdminComponent = ({
  ...
  return (
    <div className="w-full box-border opacity-[1] z-[1]  rotate-[0deg]   flex flex-nowrap justify-between items-center content-space-between p-[16px_16px_16px__16px] bg-[#000000ff] box-border border-l-[1px] border-l-[#f2f2f266] border-r-[0px] border-r-[#f2f2f266] border-t-[0px] border-t-[#f2f2f266] border-b-[0px] border-b-[#f2f2f266]">
      {/* Search1 */}
      <section className="w-[343px] h-[48px] opacity-[1] z-[0]  rotate-[0deg]   flex flex-nowrap justify-start items-center gap-[8px] p-[16px_10px_16px__10px] rounded-tl-[10px] rounded-tr-[10px] rounded-br-[10px] rounded-bl-[10px] bg-[#ffffff1f]">
        ...
        <div className="max-w-[45px] w-full box-border opacity-[1] z-[1]  rotate-[0deg]   text-left leading-[0px]">
      ...
      {/* Nav icons1 */}
      <section className="max-w-[80px] w-full box-border opacity-[1] z-[1]  rotate-[0deg]   flex flex-nowrap justify-start items-center gap-[16px] p-[0px_0px_0px__0px]">
