...
const MemberProfileEditComponent = ({
  ...
  return (
    <div className="relative flex justify-center p-[0px] box-border">
      <div className="max-w-[1112px] w-full box-border min-h-[713px] opacity-[1] z-[1]  rotate-[0deg]   flex flex-nowrap justify-between items-center content-space-between p-[40px_40px_40px__40px] rounded-tl-[24px] rounded-tr-[24px] rounded-br-[24px] rounded-bl-[24px]">
        {/* Frame 201 */}
        <section className="max-w-[470px] w-full box-border min-h-[633px] opacity-[1] z-[0]  rotate-[0deg]   flex flex-col flex-nowrap justify-start items-start gap-[24px] p-[0px_0px_0px__0px]">
          ...
          <div className="max-w-[470px] w-full box-border min-h-[514px] opacity-[1] z-[1]  rotate-[0deg]   overflow-hidden flex flex-col flex-nowrap justify-start items-start gap-[24px] p-[24px_24px_24px__24px] rounded-tl-[10px] rounded-tr-[10px] rounded-br-[10px] rounded-bl-[10px] bg-[#101010ff]">
            <div className="max-w-[422px] w-full box-border h-[74px] opacity-[1] z-[0]  rotate-[0deg]   flex flex-col flex-nowrap justify-start items-start gap-[4px] p-[0px_0px_0px__0px]">
              ...
              <input
                className="max-w-[422px] w-full box-border h-[48px] opacity-[1] z-[1]  rotate-[0deg]   flex flex-nowrap justify-start items-center p-[16px_10px_16px__10px] rounded-tl-[10px] rounded-tr-[10px] rounded-br-[10px] rounded-bl-[10px] box-border border-l-[1px] border-l-[#ffffff99] border-r-[1px] border-r-[#ffffff99] border-t-[1px] border-t-[#ffffff99] border-b-[1px] border-b-[#ffffff99]"
                type="text"
