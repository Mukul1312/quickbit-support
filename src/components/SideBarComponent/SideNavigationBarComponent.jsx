...
const SideNavigationBarComponent = ({
  ...
  return (
    <div className="max-w-[280px] min-h-[1024px] w-full box-border opacity-[1] z-[1]  rotate-[0deg]   flex flex-col flex-nowrap justify-start items-start gap-[24px] p-[0px_16px_0px__16px] bg-[#000000ff]">
      {/* logo + Collapse1 */}
